...
- Avoid using `/` for line continuation in code and CLI commands unless necessary, as behavior may become environment-dependent and cause cross-platform compatibility issues
